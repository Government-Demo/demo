package com.demo_server.common.response;


import com.demo_server.common.exception.BaseException;
import com.demo_server.common.interceptor.CommonHttpRequestInterceptor;
...
public class CommonControllerAdvice {
  ...
  public CommonResponse onException(Exception e) {
    ...
    log.error("eventId = {} e = {}", eventId, e.toString());
